...
typedef volatile short int vu16;
...
#define LCD_RST_SET   	HAL_GPIO_WritePin (LCD_SDO_GPIO_Port ,LCD_SDO_Pin ,GPIO_PIN_SET );
...
#define LCD_RST_CLR   	HAL_GPIO_WritePin (LCD_SDO_GPIO_Port ,LCD_SDO_Pin ,GPIO_PIN_RESET );
...
#define	LCD_BLK_On          LCD_BLK_SET   		 //开背光  LCD背光--PC7 	    
#define	LCD_BLK_Off         LCD_BLK_CLR    		 //关背光  LCD背光--PC7 	 
