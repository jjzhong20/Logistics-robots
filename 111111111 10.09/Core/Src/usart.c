...
/* USER CODE BEGIN 0 */
volatile uint8_t rx_len2 = 0;
volatile uint8_t recv_end_flag2=0;
uint8_t rx_buffer2[200]={0};

volatile uint8_t rx_len3 = 0;
volatile uint8_t recv_end_flag3=0;
uint8_t rx_buffer3[200]={0};

volatile uint8_t rx_len4 = 0;
volatile uint8_t recv_end_flag4=0;
uint8_t rx_buffer4[200]={0};
/* USER CODE END 0 */
